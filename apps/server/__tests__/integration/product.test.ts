...
describe('GET /products', () => {
  ...
  it('Should return 200 with a list of projected categories', async () => {
    ...
    const response = await request(await makeApp()).get('/products?project=name')
  ...
  it('Should return 200 with a list of searched categories', async () => {
    ...
    const response = await request(await makeApp()).get('/products?search=product')
...
describe('GET /products/:id', () => {
  it('SHould return 200 with product', async () => {
    ...
    const response = await request(await makeApp()).get(`/products/${product._id}`)
